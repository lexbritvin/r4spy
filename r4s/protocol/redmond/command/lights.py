...
from r4s.protocol.redmond.response.common import ErrorResponse, SuccessResponse
from r4s.protocol.redmond.response.lights import NightLightWorkTimeResponse, ColorSchemeResponse, PaletteConfigResponse
